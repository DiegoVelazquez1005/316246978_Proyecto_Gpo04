...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //// Set material properties
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1f, 0.1f, 0.1f);
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.666f, 0.666f, 0.66f);
        //glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 32.0f);


        ////ARRIBA
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 1.0f, 0.964f, 0.039f);
        //model = glm::mat4(1);
        ...
        //// Set material properties
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 0.1f, 0.1f, 0.1f);
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.333f, 0.333f, 0.333f);
        //glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 32.0f);


        ////ARRIBA
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.039f, 0.372f, 1.0f);
        //model = glm::mat4(1);
        ...
        ////ARRIBA
        //glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"), 0.176f, 0.960f, 0.0f);
        //model = glm::mat4(1);
        ...
        model = glm::mat4(1.0f);
        //model = glm::translate(model, glm::vec3(0.5f + movelightPos, 0.5f, 2.5f));
...
void KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mode)
{
    ...
    if (keys[GLFW_KEY_K])
    {
        //activanim = true; glm::vec3 lightPos(0.5f, 0.5f, 2.5f);
        lightPos.x = 0.5;
        movelightPosX += 0.1f;
        lightPos.x = lightPos.x + movelightPosX;
    }
    ...
    if (keys[GLFW_KEY_J])
    {
        ...
        lightPos.z = 2.5;
        movelightPosZ += 0.1f;
        lightPos.z = lightPos.z + movelightPosZ;
    }
    ...
    if (keys[GLFW_KEY_M])
    {
        ...
        lightPos.y = 0.5;
        movelightPosY += 0.1f;
        lightPos.y = lightPos.y + movelightPosY;
    }
